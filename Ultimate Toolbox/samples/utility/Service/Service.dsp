...
CFG=Service - Win32 Unicode_Debug
...
!MESSAGE 
!MESSAGE NMAKE /f "Service.mak" CFG="Service - Win32 Unicode_Debug"
!MESSAGE 
...
!MESSAGE "Service - Win32 Release_Shared" (based on "Win32 (x86) Application")
!MESSAGE "Service - Win32 Unicode_Debug" (based on "Win32 (x86) Application")
!MESSAGE "Service - Win32 Unicode_Release" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD LINK32 /nologo /subsystem:windows /machine:I386 /out:"Service.exe"
...
# ADD LINK32 /nologo /subsystem:windows /debug /machine:I386 /out:"Service.exe"

!ELSEIF  "$(CFG)" == "Service - Win32 Release_Shared"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 /nologo /subsystem:windows /machine:I386 /out:"Service.exe"
# ADD LINK32 /nologo /subsystem:windows /machine:I386 /out:"Service.exe"

!ELSEIF  "$(CFG)" == "Service - Win32 Unicode_Debug"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 /nologo /subsystem:windows /debug /machine:I386 /out:"Service.exe"
# ADD LINK32 /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /debug /machine:I386 /out:"Service.exe"

!ELSEIF  "$(CFG)" == "Service - Win32 Unicode_Release"

# PROP BASE Use_MFC 1
# PROP BASE Use_Debug_Libraries 0
# PROP BASE Output_Dir "Service1"
...
LINK32=link.exe
# ADD BASE LINK32 /nologo /subsystem:windows /machine:I386 /out:"Service.exe"
# ADD LINK32 /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /machine:I386 /out:"Service.exe"
...
# Name "Service - Win32 Release_Shared"
# Name "Service - Win32 Unicode_Debug"
# Name "Service - Win32 Unicode_Release"
