; /*
; Weekly MFC EXTension Support
; Copyright (c) 1997 Microsoft Corporation
;
; This file contains the message definitions for the 
; EventLogDemo.exe sample program.
...
Severity=Warning
Facility=Io
SymbolicName=MSG_UNABLE_START_GUARDIAN
Language=English
...
Severity=Success
Facility=System
SymbolicName=MSG_COMP_LOGGED_ON
Language=English
...
Facility=Runtime
SymbolicName=MSG_ULTIMATE_TOOLBOX
Language=English
