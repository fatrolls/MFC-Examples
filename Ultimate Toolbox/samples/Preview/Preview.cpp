// Preview.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CPreviewApp, COXWinApp)
...
CFileDialog* CPreviewApp::NewFileDialog(BOOL bOpenFileDialog)
{
	return new COXBmpFileDialog(bOpenFileDialog);
}
