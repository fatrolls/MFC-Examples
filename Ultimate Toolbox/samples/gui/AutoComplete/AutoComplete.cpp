// AutoComplete.cpp : Defines the class behaviors for the application.
//
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CAutoCompleteApp object

CAutoCompleteApp theApp;
static HINSTANCE g_hRichEdDLL=NULL;

/////////////////////////////////////////////////////////////////////////////
// CAutoCompleteApp initialization
...
int CAutoCompleteApp::ExitInstance()
{
	// unload the library
	if(g_hRichEdDLL!=NULL)
